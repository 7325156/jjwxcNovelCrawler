...
class noveldl():
    ...
    def get_sin(self,l):
        ...
        if fontsrc!=[]:
            ...
            fontsrc_ttf=re.sub('woff2','ttf',fontsrc)
            ...
            if not os.path.exists(self.path+"/Fonts/"+fontfamily+'.ttf'):                
                #若需要下载ttf文件，可运行下方代码
...
'''% (fontfamily,fontsrc,fontsrc_ttf,fontname,fontfamily,fontfamily,fontfamily)
