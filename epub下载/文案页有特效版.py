...
<head><title></title></head><body>''')
    ...
    def get_txt(self,txt_id,state,threadnum):
        ...
        #获取文案
        introx=ress.xpath('/html/body/table[1]/tr[1]/td[1]')
...
<head><title></title></head><body>''')
        ...
        infox=ress.xpath("//html/body/table[1]/tr/td[3]/div[2]/ul")
        print(infox)
        print(introx)
        introy=etree.tostring(introx[0],encoding="utf-8").decode()
        HtmlStr=etree.tostring(infox[0],encoding="utf-8").decode()
        fo.write(HtmlStr)
        fo.write("</blockquote>")
        fo.write(introy)
        print(introy)
